	...
	<body>
					<div class="container">
						...
						<br><br><br><br>
							...
							<h2 class="h2 text-center">iLeave <small> Sign In</small></h2>  <br><br><br>
						...
						<form action="" method="post">
							...
							<div class="form-group col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3">
							<input  value="Log In" name="btn-login" type="checkbox"><span class="login-link">Remember Me</span></input><br><br>
							<a class="login-link" href="profile/resetpass">Lost your password?</a><br><br><br>
							<a class="login-link" href="sign_up">Register Account</a><br>
							</div>
						</form>
				 </div>
<br><br>
