...
$sql = "SELECT * FROM leaves WHERE aprove='ACCEPT' AND ended='STOP'  ORDER BY id DESC";
...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li  class="active"><a href="past">Past Leaves</a></li>
          </ul>
  ...
  <div class="container"><br><br><br>
    <h2 class="text-center">Past Leaves</h2>
