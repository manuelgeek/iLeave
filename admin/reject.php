...
$sql = "SELECT * FROM leaves WHERE aprove= 'REJECT' ORDER BY id DESC";
...
<meta charset="UTF-8">
  ...
  <title>iLeave | Admin Rejected</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="aprove">Aprove Leave</a></li>
             <li class="active"><a href="reject">Rejected  Leaves</a></li>
  ...
  <div class="container"><br><br><br>
    <h2 class="text-center">Rejected Approvals</h2>
