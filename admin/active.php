...
$sql = "SELECT * FROM leaves WHERE aprove = 'ACCEPT' AND ended = '' ORDER BY id DESC";
...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="approve">Aprove Leave</a></li>
             <li><a href="reject">Rejected  Leaves</a></li>
            <li  class="active"><a href="active">Active Leaves</a></li>
  ...
  <div class="container"><br><br><br>
    <h2 class="text-center">Active Leaves</h2>
